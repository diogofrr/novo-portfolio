...
export default function Knowlegdes() {
  ...
  const descriptions = {
    ...
    TypeScript:
      "TypeScript é uma linguagem de programação que é uma extensão do JavaScript, oferecendo tipagem estática para facilitar o desenvolvimento de código mais seguro e escalável.",
    React:
      "React é uma biblioteca JavaScript amplamente utilizada para criar interfaces de usuário (UI) interativas e reativas.",
    NextJS:
      "Next.js é um framework de desenvolvimento web que se baseia no React e oferece recursos adicionais, como renderização do lado do servidor e roteamento avançado.",
    MaterialUI:
      "Material-UI é uma biblioteca de componentes React que segue as diretrizes de design do Material Design, tornando mais fácil criar interfaces atraentes e consistentes.",
    Redux:
      "Redux é uma biblioteca JavaScript para gerenciamento de estado, amplamente usada com o React, que ajuda a manter o estado da aplicação de forma previsível e escalável.",
    ...
    NodeJS:
      "Node.js é um ambiente de tempo de execução JavaScript que permite a execução de código JavaScript no lado do servidor, facilitando a criação de aplicativos web e APIs.",
    MySQL:
      "MySQL é um sistema de gerenciamento de banco de dados relacional de código aberto, amplamente usado para armazenar e gerenciar dados em aplicativos web.",
    Express:
      "Express é um framework de aplicativo web para Node.js que simplifica a criação de APIs e aplicativos web robustos e escaláveis.",
  };
      ...
      {observer && (
        <SlideFromLeftDiv>
          ...
          <Content>
            ...
            <LanguageIcons>
              <Icon
                onMouseEnter={() => setText(descriptions.Html)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
                    fill={theme.pallete.decoration}
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.Css)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.Javascript)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.TypeScript)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.React)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <g fill={theme.pallete.decoration}>
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.NextJS)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.MaterialUI)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.Redux)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.Git)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.NodeJS)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.MySQL)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
              ...
              <Icon
                onMouseEnter={() => setText(descriptions.Express)}
                onMouseLeave={() => setText("")}
              >
                <svg viewBox="0 0 128 128">
                  <path
